(() => {
  ...
  if (note) {
    note.innerHTML = '<span class="viral-live-dot"></span><div><strong>6 echte Reels live eingebettet</strong><p>Alle Videos werden direkt von Instagram geladen und sind auf der JJ-Media-Seite abspielbar.</p></div>';
  ...
  if (!document.querySelector('link[data-instagram-embeds-css]')) {
    ...
    css.rel = 'stylesheet';
    css.href = 'instagram-embeds.css?v=20260831-2';
