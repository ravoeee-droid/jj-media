(() => {
  if(document.documentElement.dataset.jjBrandRuntime==='20260905-2')return;
  document.documentElement.dataset.jjBrandRuntime='20260905-2';
  ...
  const apply=()=>{
    document.querySelectorAll('a.logo,a.blog-logo').forEach(link=>{
      ...
      img.classList.add('jj-brand-master','jj-master-logo');
